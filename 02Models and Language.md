...
In the following decades, scientists, mathematicians, philosophers and linguists created formal languages based on predicate logic. These programming languages used mathematical principles applied to [[natural language]]patterns to approximate something new. They were working to create rational, intelligent program and systems capable of human-level intelligence. 

Human wisdom and knowledge can be communicated through language. Our natural language grows organically and changes with use. Language is a predictable pattern of symbols. Initial takes on [[formal language]] models used statistical principles to break down larger problems into step-by-step approaches. Recursion allowed for complexity to be introduced. 
